...
public class ClassicSpriteRendererConversionTests : AuthoringTestFixture
{
    ...
    public void ConvertSpriteRenderer_ConvertDefault_SuccessfulConversion()
    {
        ...
        using (var spriteRendererQuery = EntityManager.CreateEntityQuery(typeof(Unity.U2D.Entities.SpriteRenderer)))
        using (var renderer2DQuery = EntityManager.CreateEntityQuery(typeof(Unity.U2D.Entities.Renderer2D)))
        {
    ...
    public void ConvertSpriteRenderer_ConvertTint_SameTint(Color tintColor)
    {
        ...
        using (var query = EntityManager.CreateEntityQuery(typeof(Unity.U2D.Entities.SpriteRenderer))) 
        using (var spriteRenderers = query.ToComponentDataArray<Unity.U2D.Entities.SpriteRenderer>(Allocator.TempJob))
        {
        ...
        [Values(1, 20, 123)] int sortOrder)
    {
        ...
        using (var query = EntityManager.CreateEntityQuery(typeof(Unity.U2D.Entities.Renderer2D))) 
        using (var renderers = query.ToComponentDataArray<Unity.U2D.Entities.Renderer2D>(Allocator.TempJob))
        {
